$(document).ready(function() {
	...
	function init() {
		...
		$("#work").click(function() {
			...
			foo += "<br><h4 style='display:inline;'>I will add a link to the class <a href='http://rpis.ec/malware' style='color:blue;'>syllabus</a> and website once they are finalized.</h4></li></ul>"
