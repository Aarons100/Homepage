$(document).ready(function() {
	...
	function init() {
		...
		var temp = "<h1 id='menu-header' class='border'>Main Menu</h1><ul><li class='border' id = 'projects'>Projects</li><br><li><a href='./resources/resume.pdf'>click here to view my résumé (PDF)</a></li><br><li><a href='http://www.rpibookswap.com'>rpibookswap.com</a></li><br><li class='border' id='about'> About Me</li></ul>"
		//put content on page
		$("#main-menu").html(temp);
